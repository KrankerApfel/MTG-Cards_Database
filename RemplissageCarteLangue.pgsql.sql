...
--Insert Into carte_langue Values
('Ancestor''s Chosen', '"First strike When Ancestor''s Chosen comes into play, you gain 1 life for each card in your graveyard."', 351, 1),
('Aven Warcraft', 'Creatures you control get +0/+2 until end of turn. Threshold - Creatures you control also gain protection from the color of your choice until end of turn. (You have threshold if seven or more cards are in your graveyard.)', 352, 1),
('Battle Screech', 'Put two 1/1 white Bird creature tokens with flying into play. Flashback-Tap three untapped white creatures you control. (You may play this card from your graveyard for its flashback cost. Then remove it from the game.)', 353, 1),
('Battlewise Aven', 'Flying. Threshold - Battlewise Aven gets +1/+1 and has first strike. (You have threshold as long as seven or more cards are in your graveyard.)', 354, 1),
('Benevolent Bodyguard', 'Sacrifice Benevolent Bodyguard: Target creature you control gains protection from the color of your choice until end of turn.', 355, 1),
('Border Patrol', 'Attacking doesn''t cause Border Patrol to tap.', 356, 1),
('Cagemail', 'Enchanted creature gets +2/+2 and can''t attack.', 357, 1),
('Chastise', 'Destroy target attacking creature. You gain life equal to its power.', 358, 1),
('Commander Eesha', 'Flying, protection from creatures', 359, 1),
('Funeral Pyre', 'Remove target card in a graveyard from the game. Its owner puts a 1/1 white Spirit creature token with flying into play.', 360, 1),
('Glory', 'Flying. 2W: Creatures you control gain protection from the color of your choice until end of turn. Play this ability only if Glory is in your graveyard.', 361, 1),
('Golden Wish', '"Choose an artifact or enchantment card you own from outside the game, reveal that card, and put it into your hand. Remove Golden Wish from the game."', 362, 1),
('Guided Strike', 'Target creature gets +1/+0 and gains first strike until end of turn. Draw a card.', 363, 1),
('Lead Astray', 'Tap up to two target creatures.', 364, 1),
('Nomad Mythmaker', 'W, {tap}: Put target enchant creature card from a graveyard into play enchanting a creature you control. (You control that enchantment.)', 365, 1),
('Phantom Flock', 'Flying. Phantom Flock comes into play with three +1/+1 counters on it. If damage would be dealt to Phantom Flock, prevent that damage. Remove a +1/+1 counter from Phantom Flock.', 366, 1),
('Phantom Nomad', 'Phantom Nomad comes into play with two +1/+1 counters on it. If damage would be dealt to Phantom Nomad, prevent that damage. Remove a +1/+1 counter from Phantom Nomad.', 367, 1),
('Prismatic Strands', 'Prevent all damage that sources of the color of your choice would deal this turn. Flashback-Tap an untapped white creature you control. (You may play this card from your graveyard for its flashback cost. Then remove it from the game.)', 368, 1),
('Pulsemage Advocate', '{tap}: Return three target cards in an opponent''s graveyard to his or her hand.  Return target creature card from your graveyard to play.', 369, 1),
('Ray of Revelation', 'Destroy target enchantment. Flashback G (You may play this card from your graveyard for its flashback cost. Then remove it from the game.)', 370, 1),
('Selfless Exorcist', '{tap}: Remove target creature card in a graveyard from the game. That card deals damage equal to its power to Selfless Exorcist. (A * on a card not in play is 0.)', 371, 1),
('Shieldmage Advocate', '{tap}: Return target card in an opponent''s graveyard to his or her hand. Prevent all damage that would be dealt to target creature or player this turn by a source of your choice.', 372, 1),
('Silver Seraph', 'Flying. Threshold - Other creatures you control get +2/+2. (You have threshold as long as seven or more cards are in your graveyard.)', 373, 1),
('Solitary Confinement', 'At the beginning of your upkeep, sacrifice Solitary Confinement unless you discard a card from your hand.Skip your draw step. You can''t be the target of spells or abilities. Prevent all damage that would be dealt to you.', 374, 1),
('Soulcatchers'' Aerie', 'Whenever a Bird is put into your graveyard from play, put a feather counter on Soulcatchers'' Aerie. All Birds get +1/+1 for each feather counter on Soulcatchers'' Aerie.', 375, 1),
('Spirit Cairn', 'Whenever a player discards a card from his or her hand, you may pay W. If you do, put a 1/1 white Spirit creature token with flying into play.', 376, 1),
('Spurnmage Advocate', '{tap}: Return two target cards in an opponent''s graveyard to his or her hand. Destroy target attacking creature.', 377, 1),
('Suntail Hawk', 'Flying.', 378, 1),
('Test of Endurance', 'At the beginning of your upkeep, if you have 50 or more life, you win the game.', 379, 1),
('Trained Pronghorn', 'Discard a card from your hand: Prevent all damage that would be dealt to Trained Pronghorn this turn.', 380, 1),
('Unquestioned Authority', 'When Unquestioned Authority comes into play, draw a card. Enchanted creature has protection from creatures.', 381, 1),
('Valor', 'First strike As long as Valor is in your graveyard and you control a plains, creatures you control have first strike.', 382, 1),
('Vigilant Sentry', 'Threshold - Vigilant Sentry gets +1/+1 and has "{tap}: Target attacking or blocking creature gets +3/+3 until end of turn." (You have threshold as long as seven or more cards are in your graveyard.)', 383, 1),
('Aven Fogbringer', 'Flying. When Aven Fogbringer comes into play, return target land to its owner''s hand.', 384, 1),
('Cephalid Constable', 'Whenever Cephalid Constable deals combat damage to a player, return up to X target permanents that player controls to their owners'' hands, where X is the damage it dealt to that player.', 385, 1),
('Cephalid Inkshrouder', 'Discard a card from your hand: Cephalid Inkshrouder can''t be the target of spells or abilities and is unblockable this turn.', 386, 1),
('Cunning Wish', 'Choose an instant card you own from outside the game, reveal that card, and put it into your hand. Remove Cunning Wish from the game.', 387, 1),
('Defy Gravity', 'Target creature gains flying until end of turn. Flashback U (You may play this card from your graveyard for its flashback cost. Then remove it from the game.)', 388, 1),
('Envelop', 'Counter target sorcery spell.', 389, 1),
('Flash of Insight', 'Look at the top X cards of your library. Put one of them into your hand and the rest on the bottom of your library. Flashback-1U, Remove X blue cards in your graveyard from the game. (You can''t remove Flash of Insight to pay for its own flashback cost.)', 390, 1),
('Grip of Amnesia', 'Counter target spell unless its controller removes his or her graveyard from the game. Draw a card.', 391, 1),
('Hapless Researcher', 'Sacrifice Hapless Researcher: Draw a card, then discard a card from your hand.', 392, 1),
('Keep Watch', 'Draw a card for each attacking creature.', 393, 1),
('Laquatus''s Disdain', 'Counter target spell played from a graveyard. Draw a card.', 394, 1),
('Lost in Thought', 'Enchanted creature can''t attack or block and its activated abilities can''t be played. Its controller may remove three cards in his or her graveyard from the game to ignore this ability until end of turn.', 395, 1),
('Mental Note', 'Put the top two cards of your library into your graveyard. Draw a card.', 396, 1),
('Mirror Wall', '(Walls can''t attack.) W: Mirror Wall may attack this turn as though it weren''t a Wall. ', 397, 1),
('Mist of Stagnation', 't untap during their controllers'' untap steps. At the beginning of each player''s upkeep, that player untaps a permanent for each card in his or her graveyard.', 398, 1),
('Quiet Speculation', 'Search target player''s library for up to three cards with flashback and put them into that player''s graveyard. Then the player shuffles his or her library.', 399, 1),
('Scalpelexis', 'Flying. Whenever Scalpelexis deals combat damage to a player, that player removes the top four cards of his or her library from the game. If two or more of those cards have the same name, repeat this process.', 400, 1),
('Spelljack', 'Counter target spell. If it''s countered this way, remove it from the game instead of putting it into its owner''s graveyard. As long as it remains removed from the game, you may play it as though it were in your hand without paying its mana cost. If it has X in its mana cost, X is 0.', 401, 1),
('Telekinetic Bonds', 'Whenever a player discards a card from his or her hand, you may pay 1U. If you do, tap or untap target permanent.', 402, 1),
('Web of Inertia', 'At the beginning of each opponent''s combat phase, that player may remove a card in his or her graveyard from the game. If the player t, creatures he or she controls can''t attack you this turn.', 403, 1),
('Wonder', 'Flying. As long as Wonder is in your graveyard and you control an island, creatures you control have flying.', 404, 1),
('Wormfang Behemoth', 'When Wormfang Behemoth comes into play, remove all cards in your hand from the game. When Wormfang Behemoth leaves play, return the removed cards to their owner''s hand.', 405, 1),
('Wormfang Crab', 'Wormfang Crab is unblockable. When Wormfang Crab comes into play, an opponent chooses a permanent you control and removes it from the game. When Wormfang Crab leaves play, return the removed card to play under its owner''s control.', 406, 1),
('Wormfang Drake', 'Flying. When Wormfang Drake comes into play, sacrifice it unless you remove a creature you control other than Wormfang Drake from the game. When Wormfang Drake leaves play, return the removed card to play under its owner''s control.', 407, 1),
('Wormfang Manta', 'Flying. When Wormfang Manta comes into play, you skip your next turn. When Wormfang Manta leaves play, you take an extra turn after this one.', 408, 1),
('Wormfang Newt', 'When Wormfang Newt comes into play, remove a land you control from the game. When Wormfang Newt leaves play, return the removed card to play under its owner''s control.', 409, 1),
('Wormfang Turtle', 'When Wormfang Turtle comes into play, remove a land you control from the game. When Wormfang Turtle leaves play, return the removed card to play under its owner''s control.', 410, 1),
('Balthor the Defiled', 'All Minions get +1/+1. BBB, Remove Balthor the Defiled from the game: Each player returns all black and all red creature cards from his or her graveyard to play.', 411, 1),
('Cabal Therapy', 'Name a nonland card. Target player reveals his or her hand and discards from it all cards with that name. Flashback-Sacrifice a creature. (You may play this card from your graveyard for its flashback cost. Then remove it from the game.)', 412, 1),
('Cabal Trainee', 'Sacrifice Cabal Trainee: Target creature gets -2/-0 until end of turn.', 413, 1),
('Death Wish', 'Choose a card you own from outside the game and put it into your hand. You lose half your life, rounded up. Remove Death Wish from the game.', 414, 1),
('Earsplitting Rats', 'When Earsplitting Rats comes into play, each player discards a card from his or her hand. Discard a card from your hand: Regenerate Earsplitting Rats.', 415, 1),
('Filth', 'Swampwalk As long as Filth is in your graveyard and you control a swamp, creatures you control have swampwalk.', 416, 1),
('Grave Consequences', 'Each player may remove any number of cards in his or her graveyard from the game. Then each player loses 1 life for each card in his or her graveyard. Draw a card.', 417, 1),
('Guiltfeeder', 'Guiltfeeder can''t be blocked except by artifact creatures and/or black creatures. Whenever Guiltfeeder attacks and isn''t blocked, defending player loses 1 life for each card in his or her graveyard.', 418, 1),
('Masked Gorgon', 'Green creatures and white creatures have protection from Gorgons. Threshold - Masked Gorgon has protection from green and from white. (You have threshold as long as seven or more cards are in your graveyard.)', 419, 1),
('Morality Shift', 'Exchange your graveyard and library. Then shuffle your library.', 420, 1),
('Rats'' Feast', 'Remove X target cards in a single graveyard from the game.', 421, 1),
('Stitch Together', 'Return target creature card from your graveyard to your hand. Threshold - Instead return that card from your graveyard to play. (You have threshold if seven or more cards are in your graveyard.)', 422, 1),
('Sutured Ghoul', 'Trample. As Sutured Ghoul comes into play, remove any number of creature cards in your graveyard from the game. Sutured Ghoul''s power is equal to the total power of the removed cards and its toughness is equal to their total toughness. (A * on a card not in play is 0.)', 423, 1),
('Toxic Stench', 'Target nonblack creature gets -1/-1 until end of turn. Threshold - Instead destroy that creature. It can''t be regenerated. (You have threshold if seven or more cards are in your graveyard.)', 424, 1),
('Treacherous Vampire', 'Flying. Whenever Treacherous Vampire attacks or blocks, sacrifice it unless you remove a card in your graveyard from the game. Threshold - Treacherous Vampire gets +2/+2 and has "When Treacherous Vampire is put into a graveyard from play, you lose 6 life.', 425, 1),
('Treacherous Werewolf', 'Threshold - Treacherous Werewolf gets +2/+2 and has "When Treacherous Werewolf is put into a graveyard from play, you lose 4 life." (You have threshold as long as seven or more cards are in your graveyard.)', 426, 1),
('Anger', 'Haste. As long as Anger is in your graveyard and you control a mountain, creatures you control have haste.', 427, 1),
('Arcane Teachings', 'Enchanted creature gets +2/+2 and has "{tap}: This creature deals 1 damage to target creature or player.', 428, 1),
('Barbarian Bully', 'Discard a card at random from your hand: Barbarian Bully gets +2/+2 until end of turn unless a player has Barbarian Bully deal 4 damage to him or her. Play this ability only once each turn.', 429, 1),
('Book Burning', 'Unless a player has Book Burning deal 6 damage to him or her, put the top six cards of target player''slibrary into his or her graveyard.', 430, 1),
('Breaking Point', 'Destroy all creatures unless a player has Breaking Point deal 6 damage to him or her. Creatures destroyed this way can''t be regenerated.', 431, 1),
('Browbeat', 'Unless a player has Browbeat deal 5 damage to him or her, target player draws three cards.', 432, 1),
('Burning Wish', 'Choose a sorcery card you own from outside the game, reveal that card, and put it into your hand. RemoveBurning Wish from the game.', 433, 1),
('Dwarven Bloodboiler', 'Tap an untapped Dwarf you control: Target creature gets +2/+0 until end of turn.', 434, 1),
('Dwarven Driller', '{tap}: Destroy target land unless its controller has Dwarven Driller deal 2 damage to him or her.', 435, 1),
('Dwarven Scorcher', 'Sacrifice Dwarven Scorcher: Dwarven Scorcher deals 1 damage to target creature unless that creature''s controller has Dwarven Scorcher deal 2 damage to him or her.', 436, 1),
('Ember Shot', 'Ember Shot deals 3 damage to target creature or player. Draw a card.', 437, 1),
('Firecat Blitz', 'Put X 1/1 red Cat creature tokens with haste into play. Remove them from the game at end of turn. Flashback-RR, Sacrifice X mountains. (You may play this card from your graveyard for its flashback cost. Then remove it from the game.)', 438, 1),
('Flaring Pain', 'Damage can''t be prevented this turn. Flashback R (You may play this card from your graveyard for its flashback cost. Then remove it from the game.)', 439, 1),
('Fledgling Dragon', 'Flying. Threshold - Fledgling Dragon gets +3/+3 and has "R: Fledgling Dragon gets +1/+0 until end of turn." (You have threshold as long as seven or more cards are in your graveyard.)', 440, 1),
('Goretusk Firebeast', 'When Goretusk Firebeast comes into play, it deals 4 damage to target player.', 441, 1),
('Infectious Rage', 'Enchanted creature gets +2/-1. When enchanted creature is put into a graveyard, choose a creature at random Infectious Rage can enchant. Return Infectious Rage to play enchanting that creature.', 442, 1),
('Jeska, Warrior Adept', 'First strike, haste. {tap}: Jeska, Warrior Adept deals 1 damage to target creature or player.', 443, 1),
('Lava Dart', 'Lava Dart deals 1 damage to target creature or player. Flashback-Sacrifice a mountain. (You may play this card from your graveyard for its flashback cost. Then remove it from the game.)', 444, 1),
('Liberated Dwarf', 'R, Sacrifice Liberated Dwarf: Target green creature gets +1/+0 and gains first strike until end of turn.', 445, 1),
('Lightning Surge', 'Lightning Surge deals 4 damage to target creature or player. Threshold - Instead Lightning Surge deals 6 damage to that creature or player and the damage can''t be prevented. Flashback 5RR (You may play this card from yourgraveyard for its flashback cost. Then remove it from the game.)', 446, 1),
('Planar Chaos', 'At the beginning of your upkeep, flip a coin. If you lose the flip, sacrifice Planar Chaos. Whenever a player plays a spell, that player flips a coin. If he or she loses the flip, counter that spell.', 447, 1),
('Shaman''s Trance', 'Until end of turn, other players can''t play cards from their graveyards, and you may play cards from other players'' graveyards as though they were in your graveyard.', 448, 1),
('Soulgorger Orgg', 'Trample. When Soulgorger Orgg comes into play, you lose all but 1 life. When Soulgorger Orgg leaves play, you gain life equal to the life you lost when it came into play.', 449, 1),
('Spellgorger Barbarian', 'When Spellgorger Barbarian comes into play, discard a card at random from your hand. When Spellgorger Barbarian leaves play, draw a card.', 450, 1),
('Swelter', 'Swelter deals 2 damage to each of two target creatures.', 451, 1),
('Swirling Sandstorm', 'Threshold - Swirling Sandstorm deals 5 damage to each creature without flying. (You have threshold if seven or more cards are in your graveyard.)', 452, 1),
('Worldgorger Dragon', 'Flying, trample. When Worldgorger Dragon comes into play, remove all other permanents you control from the game. When Worldgorger Dragon leaves play, return the removed cards to play under their owners'' control.', 453, 1),
('Anurid Barkripper', 'Threshold - Anurid Barkripper gets +2/+2. (You have threshold as long as seven or more cards are in your graveyard.)', 454, 1),
('Anurid Swarmsnapper', 'Anurid Swarmsnapper may block as though it had flying. 1G: Anurid Swarmsnapper may block an additional creature this turn.', 455, 1),
('Battlefield Scrounger', 'Threshold - Put three cards from your graveyard on the bottom of your library: Battlefield Scrounger gets +3/+3 until end of turn. Play this ability only once each turn. (Play this ability only if seven or more cards are in yourgraveyard.)', 456, 1),
('Brawn', 'Trample. As long as Brawn is in your graveyard and you control a forest, creatures you control have trample.', 457, 1),
('Canopy Claws', 'Target creature loses flying until end of turn. Flashback G (You may play this card from your graveyard for its flashback cost. Then remove it from the game.)', 458, 1),
('Centaur Rootcaster', 'Whenever Centaur Rootcaster deals combat damage to a player, you may search your library for a basic land card and put that card into play tapped. If you do, shuffle your library.', 459, 1),
('Crush of Wurms', 'Put three 6/6 green Wurm creature tokens into play. Flashback 9GGG (You may play this card from your graveyard for its flashback cost. Then remove it from the game.)', 460, 1),
('Elephant Guide', 'Enchanted creature gets +3/+3. When enchanted creature is put into a graveyard, put a 3/3 green Elephant creature token into play.', 461, 1),
('Epic Struggle', 'At the beginning of your upkeep, if you control twenty or more creatures, you win the game.', 462, 1),
('Erhnam Djinn', 'At the beginning of your upkeep, target non-Wall creature an opponent controls gains forestwalk until your next upkeep.', 463, 1),
('Exoskeletal Armor', 'Enchanted creature gets +X/+X, where X is the number of creature cards in all graveyards.', 464, 1),
('Folk Medicine', 'You gain 1 life for each creature you control. Flashback 1W (You may play this card from your graveyard for its flashback cost. Then remove it from the game.)', 465, 1),
('Forcemage Advocate', '{tap}: Return target card in an opponent''s graveyard to his or her hand. Put a +1/+1 counter on target creature.', 466, 1),
('Genesis', 'At the beginning of your upkeep, if Genesis is in your graveyard, you may pay 2G. If you do, return target creature card from your graveyard to your hand."', 467, 1),
('Giant Warthog', 'Trample', 468, 1),
('Grizzly Fate', 'Put two 2/2 green Bear creature tokens into play. Threshold - Instead put four 2/2 green Bear creature tokens into play. Flashback 5GG (You may play this card from your graveyard for its flashback cost. Then remove it from the game.)', 469, 1),
('Harvester Druid', '{tap}: Add to your mana pool one mana of any color that a land you control could produce.', 470, 1),
('Ironshell Beetle', 'When Ironshell Beetle comes into play, put a +1/+1 counter on target creature.', 471, 1),
('Krosan Reclamation', 'Target player shuffles up to two target cards from his or her graveyard into his or her library. Flashback 1G (You may play this card from your graveyard for its flashback cost. Then remove it from the game.)', 472, 1),
('Krosan Wayfarer', 'Sacrifice Krosan Wayfarer: Put a land card from your hand into play.', 473, 1),
('Living Wish', 'Choose a creature or land card you own from outside the game, reveal that card, and put it into your hand. Remove Living Wish from the game.', 474, 1),
('Nantuko Tracer', 'When Nantuko Tracer comes into play, you may put target card from a graveyard on the bottom of its owner''s library.', 475, 1),
('Nullmage Advocate', '{tap}: Return two target cards in an opponent''s graveyard to his or her hand. Destroy target artifact or enchantment.', 476, 1),
('Phantom Centaur', 'Protection from black. Phantom Centaur comes into play with three +1/+1 counters on it. If damage would be dealt to Phantom Centaur, prevent that damage. Remove a +1/+1 counter from Phantom Centaur.', 477, 1),
('Phantom Nantuko', 'Trample. Phantom Nantuko comes into play with two +1/+1 counters on it. If damage would be dealt to Phantom Nantuko, prevent that damage. Remove a +1/+1 counter from Phantom Nantuko. {tap}: Put a +1/+1 counter on Phantom Nantuko.', 478, 1),
('Phantom Tiger', 'Phantom Tiger comes into play with two +1/+1 counters on it. If damage would be dealt to Phantom Tiger, prevent that damage. Remove a +1/+1 counter from Phantom Tiger.', 479, 1),
('Seedtime', 'Play Seedtime only during your turn. Take an extra turn after this one if an opponent played a blue spell this turn.', 480, 1),
('Serene Sunset', 'Prevent all combat damage X target creatures would deal this turn.', 481, 1),
('Sudden Strength', 'Target creature gets +3/+3 until end of turn. Draw a card.', 482, 1),
('Sylvan Safekeeper', 'Sacrifice a land: Target creature you control can''t be the target of spells or abilities this turn.', 483, 1),
('"Thriss, Nantuko Primus"', 'G, {tap}: Target creature gets +5/+5 until end of turn.', 484, 1),
('Tunneler Wurm', 'Discard a card from your hand: Regenerate Tunneler Wurm.', 485, 1),
('Venomous Vines', 'Destroy target enchanted permanent.', 486, 1),
('Anurid Brushhopper', 'Discard two cards from your hand: Remove Anurid Brushhopper from the game. Return it to play under its owner''s control at end of turn.', 487, 1),
('Hunting Grounds', 'Threshold - Whenever an opponent plays a spell, you may put a creature card from your hand into play. (You have threshold as long as seven or more cards are in your graveyard.)', 488, 1),
('Mirari''s Wake', 'Creatures you control get +1/+1. Whenever you tap a land for mana, add one mana to your mana pool of any type that land produced.', 489, 1),
('Phantom Nishoba ', 'Trample. Phantom Nishoba comes into play with seven +1/+1 counters on it. Whenever Phantom Nishoba deals damage, you gain that much life. If damage would be dealt to Phantom Nishoba, prevent that damage. Remove a +1/+1 counter from Phantom Nishoba.', 490, 1),
('Krosan Verge', 'Krosan Verge comes into play tapped. {tap}: Add one colorless mana to your mana pool. 2, {tap}, Sacrifice Krosan Verge: Search your library for a forest card and a plains card and put them into play tapped. Then shuffle your library.', 491, 1),
('Nantuko Monastery', '{tap}: Add one colorless mana to your mana pool. Threshold - GW: Nantuko Monastery becomes a 4/4 green and white creature with first strike until end of turn. It''s still a land. (Play this ability only if seven or more cards are in your graveyard.)', 492, 1),
('Riftstone Portal', '{tap}: Add one colorless mana to your mana pool. As long as Riftstone Portal is in your graveyard, lands you control have "{tap}: Add G or W to your mana pool."', 493, 1);
